...
<rapid:override name="content">
    ...
    <form class="layui-form" method="post" id="myForm" action="/admin/article/insertSubmit">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <div id="editormd-wrapper">
                    <div id="editormd">
                        <textarea name="articleContent" id="articleContent" placeholder="请输入文章内容，支持 Markdown 语法..."></textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <blockquote class="layui-elem-quote layui-quote-nm">
            温馨提示：<br>
            1、文章内容的数据表字段类型为 MEDIUMTEXT，每篇文章内容请不要超过 500 万字 <br>
            2、写文章之前，请确保标签和分类存在，否则可以先新建；请勿刷新页面，博客不会自动保存 <br>
            3、本编辑器支持 <strong>Markdown</strong> 语法，右侧可实时预览效果<br>
            4、插入代码块会自动高亮，支持语法：Java、JavaScript、Python、SQL 等主流语言
